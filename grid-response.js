jsPsych.plugins['grid-response'] = (function(){
    ...
    plugin.trial = function(display_element, trial){
        ...
        <div class="grid-label">high arousal (exciting, agitating)</div>
        <div class="flex">
        <div class="grid-label grid-input-label-left">low valence (unpleasant)</div>
        <div id="grid-input-container">
            <div id="grid-input-pos-indicator"></div>
        </div>
        <div class="grid-label grid-input-label-right">high valence (pleasant)</div>
        </div>
        <div class="grid-label">low arousal (soothing, calming)</div>
        `;
        ...
        confidence = 1; //default value (100 %)
