...
function run_experiment(videos){ //called after get_videos finished retrieving video IDs from server
    ...
    let intro_trial = {
        ...
        <p><b>Please make sure your volume is turned up before you start the experiment!</b></p>`,
    ...
    let main_experiment = {
        ...
        timeline: [intro_trial, rating_procedure, prolific_id_trial, goodbye_trial],
    };
