...
const VIDEO_BASE_URL = 'resources/mp4/';
...
function run_experiment(videos){ //called after get_videos finished retrieving video IDs from server
    ...
    let intro_trial = {
        ...
        <p>In the following task, you will be asked to assess ${VIDEOS_PER_USER} videos of a robot as a combination of two independent variables <b>valence</b> (i.e. pleasantness) and <b>arousal</b> (i.e. intensity).<br></p>
        ...
        <p><b>For each video, please select how you perceive the emotion displayed by the robot. Some videos show the robot idle for a short amount of time - in this case, focus on the part where the robot is active.</b></p>
    ...
    let grid_explanation_trial = {
        ...
        stimulus: `
            ...
            <img src="resources/grid.png" class="grid-screenshot" />
