...
function run_experiment(videos){ //called after get_videos finished retrieving video IDs from server
    let hello_trial = {
        ...
        <p style="width: 600px">In this task, you will be asked to rate ${VIDEOS_PER_USER} videos of a robot
    ...
    let instruction_trial = { //bad HTML
        type: 'html-keyboard-response',
        stimulus: `<p>Instructions</p>
        <p style="width: 600px">
            <b>high valence:</b> pleasant<br>
            <b>low valence:</b> unpleasant<br>
            <b>high arousal:</b> exciting, agitating<br>
            <b>low arousal:</b> soothing, calming
        </p>`,
    };
