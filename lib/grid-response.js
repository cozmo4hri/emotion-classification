jsPsych.plugins['grid-response'] = (function(){
    ...
    plugin.trial = function(display_element, trial){
        ...
        <div class="flex">
        <div class="grid-label grid-input-label-left">
            <span class="smol-label">unactivated<br>relaxed</span>
            <b>arousal</b>
            <span class="smol-label">activated<br>stimulated</span></div>
        <div id="grid-input-container">
            <div id="grid-input-pos-indicator"></div>
        </div>
        <div class="grid-label grid-input-label-right"></div>
        </div>
        <div class="grid-label grid-label-bottom">
            <span class="smol-label">negative</span>
            <b>valence</b>
            <span class="smol-label">positive</span></div>
        </div>
        `;
        ...
        let confidence_slider = `
            ...
            <div id="conf-label"><span id="conf-val">--</span>%</div>
            </label>`;
